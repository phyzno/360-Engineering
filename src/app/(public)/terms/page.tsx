      ...
      <div className="container-wide max-w-4xl mx-auto">
        ...
        <div className="space-y-8 text-gray-500 text-lg leading-relaxed">
          ...
          <section className="mt-12">
            <h2 className="font-heading text-h3 text-[var(--color-brand-500)] mb-6">1. Intellectual Property</h2>
            <p>
          ...
          <section className="mt-12">
            <h2 className="font-heading text-h3 text-[var(--color-brand-500)] mb-6">2. Links To Other Web Sites</h2>
            <p className="mb-4">
          ...
          <section className="mt-12">
            <h2 className="font-heading text-h3 text-[var(--color-brand-500)] mb-6">3. Termination</h2>
            <p>
          ...
          <section className="mt-12">
            <h2 className="font-heading text-h3 text-[var(--color-brand-500)] mb-6">4. Limitation Of Liability</h2>
            <p>
          ...
          <section className="mt-12">
            <h2 className="font-heading text-h3 text-[var(--color-brand-500)] mb-6">5. Changes</h2>
            <p>
