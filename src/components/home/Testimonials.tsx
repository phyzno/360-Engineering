...
const testimonials = [
  {
    id: 1,
    quote: "DF Interiors didn't just redesign our home; they reimagined how we live. The attention to detail and connection to natural elements is unparalleled.",
  ...
  {
    id: 2,
    quote: "Working with the DF Interiors team was a seamless experience. They understood our brand vision perfectly and translated it into a breathtaking commercial space.",
